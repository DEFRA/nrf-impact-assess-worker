...
class ScriptSettings(BaseSettings):
    ...
    coefficient_layer: str = Field(description="Layer name within coefficient GeoPackage")
    ...
    nn_catchment_shapefile: str = Field(description="NN catchments shapefile path (relative)")
    subcatchment_shapefile: str = Field(description="Subcatchments shapefile path (relative)")
