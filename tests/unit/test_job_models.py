...
from worker.models.job import AssessmentType, ImpactAssessmentJob
...
def test_impact_assessment_job_valid():
    ...
    job = ImpactAssessmentJob(
        ...
        submitted_at=datetime(2025, 10, 15, 14, 30, 0),
    ...
    assert job.submitted_at == datetime(2025, 10, 15, 14, 30, 0)
...
def test_impact_assessment_job_json_serialization():
    ...
    assert job_restored.submitted_at == job.submitted_at
