...
from worker.assessments.gcn import (
    GcnAssessment,
    ...
    return gpd.GeoDataFrame(
        {
            "RZ": ["Red", "Amber", "Green"],
            "geometry": [
                Polygon([(450000, 100000), (450050, 100000), (450050, 100050), (450000, 100050)]),
                Polygon([(450050, 100000), (450100, 100000), (450100, 100050), (450050, 100050)]),
                Polygon([(450000, 100050), (450050, 100050), (450050, 100100), (450000, 100100)]),
            ],
        },
        crs="EPSG:27700",
    )
    ...
    return gpd.GeoDataFrame(
        {
            "edge_id": [1],
            "geometry": [
                Polygon([(450000, 100000), (450200, 100000), (450200, 100200), (450000, 100200)])
            ],
        },
        crs="EPSG:27700",
    )
...
def test_run_assessment_survey_ponds_missing_pans(sample_rlb, mock_repository, tmp_path):
...
def test_calculate_habitat_impact_basic():
    ...
    # Create ponds
    ponds = gpd.GeoDataFrame({"geometry": [Point(25, 50), Point(75, 50)]}, crs="EPSG:27700")
...
def test_calculate_pond_frequency_basic():
    ...
    ponds_in_buffer = gpd.GeoDataFrame(
        {"PANS": ["P"], "TmpImp": ["T"], "Area": ["Buffer"], "geometry": [Point(30, 30)]},
        crs="EPSG:27700",
    )
